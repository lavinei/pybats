...
from .forecast import forecast_marginal, forecast_path, forecast_path_approx, forecast_marginal_bindglm, \
    forecast_path_normaldlm
...
class dglm:
    ...
    def __init__(self,
        ...
        :param positive_regn_discount: Whether to only discount when we have a non-zero regression input
        ...
        self.positive_regn_discount = positive_regn_discount
    ...
    def get_W(self, X=None):
        if self.positive_regn_discount and X is not None:
